...
public class AuthController {
    ...
    public Map<String, String> changePassword(@RequestParam String role,
        ...
        // 使用原密码确认账号归属，确认通过后才允许修改。
        User user = userRepository.findByUsernameAndPasswordAndRole(normalizedUsername, currentPassword, normalizedRole)
                .orElseThrow(() -> new RuntimeException("账号或原密码错误"));
