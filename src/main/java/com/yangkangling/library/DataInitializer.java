...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (userRepository.findByUsername("admin").isEmpty()) {
            ...
            admin.setPassword(passwordService.encode(libraryProperties.getDefaultAdminPassword()));
        ...
        if (userRepository.findByUsername("R20260001").isEmpty()) {
            ...
            reader.setPassword(passwordService.encode(libraryProperties.getDefaultReaderPassword()));
