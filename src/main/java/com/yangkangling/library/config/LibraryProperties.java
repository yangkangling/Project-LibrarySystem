...
public class LibraryProperties {
    ...
    private String defaultReaderPassword = "123456";
    ...
    public void setDefaultAdminPassword(String defaultAdminPassword) {
        this.defaultAdminPassword = normalizePassword(defaultAdminPassword);
    }

    public String getDefaultReaderPassword() {
        return defaultReaderPassword;
    }

    public void setDefaultReaderPassword(String defaultReaderPassword) {
        this.defaultReaderPassword = normalizePassword(defaultReaderPassword);
    }
